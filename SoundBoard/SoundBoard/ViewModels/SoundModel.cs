...
namespace SoundBoard.ViewModels
{
    public class SoundModel
    {
        ...
        private SoundGroup CreateCartoonsGroup()
        {
            ...
            data.Items.Add(new SoundData { Title = "Boing", 
                FilePath = basePath + "Boing.wav" });

            data.Items.Add(new SoundData { Title = "Bronk", 
                FilePath = basePath + "Bronk.wav" });

            data.Items.Add(new SoundData { Title = "Bugle charge", 
                FilePath = basePath + "Bugle charge.wav" });

            data.Items.Add(new SoundData { Title = "Laser", 
                FilePath = basePath + "Laser.wav" });

            data.Items.Add(new SoundData { Title = "Out Here", 
                FilePath = basePath + "Out Here.wav" });

            data.Items.Add(new SoundData { Title = "Splat", 
        ...
        private SoundGroup CreateTauntsGroup()
        {
            ...
            data.Items.Add(new SoundData { Title = "Cackle", 
                FilePath = basePath + "Cackle.wav" });

            data.Items.Add(new SoundData { Title = "Clock Ticking", 
                FilePath = basePath + "Clock Ticking.wav" });

            data.Items.Add(new SoundData { Title = "Dial up", 
                FilePath = basePath + "Dial up.wav" });

            data.Items.Add(new SoundData { Title = "Drum roll", 
                FilePath = basePath + "Drum roll.wav" });

            data.Items.Add(new SoundData { Title = "Elevator Music", 
                FilePath = basePath + "Elevator Music.wav" });

            data.Items.Add(new SoundData { Title = "Laugh", 
                FilePath = basePath + "Laugh.wav" });

            data.Items.Add(new SoundData { Title = "Laugh - Evil", 
                FilePath = basePath + "Laugh - Evil.wav" });

            data.Items.Add(new SoundData { Title = "Wrong Price", 
                FilePath = basePath + "Wrong Price.wav" });

            data.Items.Add(new SoundData { Title = "Sad Trombone", 
                FilePath = basePath + "Sad Trombone.wav" });

            data.Items.Add(new SoundData { Title = "Sarcastic Ooo", 
                FilePath = basePath + "Sarcastic Ooo.wav" });

            data.Items.Add(new SoundData { Title = "Sigh", 
                FilePath = basePath + "Sigh.wav" });

            data.Items.Add(new SoundData { Title = "Snore", 
                FilePath = basePath + "Snore.wav" });

            data.Items.Add(new SoundData { Title = "Yawn", 
        ...
        private SoundGroup CreateWarningsGroup()
        {
            ...
            data.Items.Add(new SoundData { Title = "Air horn", 
                FilePath = basePath + "Air horn.wav" });

            data.Items.Add(new SoundData { Title = "Air Raid", 
                FilePath = basePath + "Air Raid.wav" });

            data.Items.Add(new SoundData { Title = "Alarm Clock - Electric", 
                FilePath = basePath + "Alarm Clock - Electric.wav" });

            data.Items.Add(new SoundData { Title = "Alarm Clock - Bell",
                FilePath = basePath + "Alarm Clock - Bell.wav" });

            data.Items.Add(new SoundData { Title = "Backing up", 
                FilePath = basePath + "Backing up.wav" });

            data.Items.Add(new SoundData { Title = "Bell - Church", 
                FilePath = basePath + "Bell - Church.wav" });

            data.Items.Add(new SoundData { Title = "Bell - School", 
                FilePath = basePath + "Bell - School.wav" });

            data.Items.Add(new SoundData { Title = "Fog horn", 
                FilePath = basePath + "Fog horn.wav" });

            data.Items.Add(new SoundData { Title = "Glass breaking", 
                FilePath = basePath + "Glass breaking.wav" });

            data.Items.Add(new SoundData { Title = "Missle alert", 
                FilePath = basePath + "Missle alert.wav" });

            data.Items.Add(new SoundData { Title = "Police - UK", 
                FilePath = basePath + "Police - UK.wav" });

            data.Items.Add(new SoundData { Title = "Police - US", 
                FilePath = basePath + "Police - US.wav" });

            data.Items.Add(new SoundData { Title = "Vuvuzela",
